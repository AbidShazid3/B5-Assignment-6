...
const AllAgent = () => {
    ...
    const { data: agentData, isLoading, isError } = useGetAllAgentQuery(query);
    const [updateStatus] = useUpdateUserStatusMutation();
    const totalPage = agentData?.meta?.totalPage || 1;
    ...
    useEffect(() => {
        setSearchParams({ page: currentPage.toString(), limit: limit.toString(), sort, search, status })
    }, [currentPage, limit, sort, search, setSearchParams, status])
        ...
        <div>
            ...
            <div className="overflow-hidden rounded-md border mt-5">
                <Table>
                    ...
                    {!isLoading && !isError && agentData?.data?.length > 0 && (
                        <TableBody>
